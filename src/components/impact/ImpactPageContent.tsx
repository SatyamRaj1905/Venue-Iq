    ...
    <>
      <section className="impact-intro" aria-labelledby="impact-model-title">
        ...
        <p>
          ...
          day safer, calmer and more inclusive. The figures below describe this seeded
          demonstration, not real venue performance.
        </p>
      </section>
      ...
      <section className="impact-responsibility" aria-labelledby="responsibility-title">
        <div className="impact-responsibility__copy">
          ...
          <p>
            Generative AI can make complex venue information easier to use. It should not invent
            that information, conceal uncertainty or silently make safety-critical choices.
          </p>
          <ul>
            <li>
